  ...
  return (
    ...
    <div className="container">
      <div className='row '>
        ...
        <h1 className='text-center text-light fs-1 mt-5 addfooditems-heading'>Add Food Item</h1>
        {err.length!==0 && <p className='text-danger fs-3 text-center'>{err}</p>}
          <form className='mt-4' onSubmit={handleSubmit(submitForm)}>
            <label htmlFor='foodname'  className="text-light fs-4 mt-3">Food Name</label>
            <input type="text" id="foodname" className='form-control mt-3' placeholder="" {...register("foodname",{required:true})}/>
            {errors.foodname?.type==="required"&&<p className='text-danger fs-4'>*name of the food required</p>}

            <label htmlFor='foodcost'  className="text-light fs-4 mt-3">Food Cost</label>
            <input type="number" id="foodcost" className='form-control mt-3' placeholder="" {...register("foodcost",{required:true})}/>
            {errors.foodcost?.type==="required"&&<p className='text-danger fs-4'>*cost of the food required</p>}

            <label htmlFor='foodimage'  className="text-light fs-4 mt-3">Food Image</label>
            ...
            <label htmlFor='foodType'  className="text-light fs-4 mt-3">Food Type</label>
            <select className='form-control mt-3' id="foodType" {...register("foodtype",{required:true})} >
                        ...
                        <option value="mock-tails" >mock-tails</option>
                      </select>
