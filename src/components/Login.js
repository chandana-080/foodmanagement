    ...
    <div className="container ">
        <div className='row form-style '>
            ...
            <label htmlFor="username"  className="  fs-4 mt-3">username</label>
                    ...
                    <label htmlFor="password"  className="text-secondary fs-4 mt-3">Password</label>
                    <input type="password" className='form-control mt-1' placeholder='Example:John@09' id="password" {...register("password",{required:true})} />
